...
public class CarPark {
	...
	// make an ArrayList for recording the car park and queue;
	private ArrayList<Integer> archivesList;
	...
	public CarPark(int maxCarSpaces, int maxSmallCarSpaces,
		...
		archivesList = new ArrayList<Integer>(maxCarSpaces);
		queueList = new ArrayList<Integer>(maxQueueSize);
	}
	...
	public boolean carParkFull() {
		if (archivesList.size() == maxCarSpaces) {
			return true;
		} else {
			return false;
		}
	...
	public boolean queueFull() {
		if (queueList.size() == maxQueueSize) {
			return true;
		} else {
			return false;
		}
